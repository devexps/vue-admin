...
export async function createViteConfig(
  ...
  console.log(
    red(
      'Currently in the development and testing stage, there will be a lot of updates, for reference only, do not use for actual projects!\n',
    ),
  )
  console.log()
  ...
  const commonConfig: UserConfig = {
    ...
    optimizeDeps: {
      include: ['dayjs/locale/en', 'dayjs/locale/vi', '@iconify/iconify'],
      // exclude: ['vue-demi'],
    },
