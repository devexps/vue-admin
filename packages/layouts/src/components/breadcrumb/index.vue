...
import { useAppConfig, useGo } from '@devexps/hooks'
...
import { getMenus, getAllParentPath } from '@devexps/router'
...
<template>
  <DevexpsSpace align="center" justify="space-between" class="pl-8px pr-8px">
    <DevexpsBreadcrumb v-if="header.showBreadCrumb">
