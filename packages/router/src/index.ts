import { DefineAppConfigOptions } from '@devexps/types'
import { PermissionModeEnum } from '@devexps/constants'
import { useAppConfig } from '@devexps/stores'
import { _assign } from '@devexps/utils'
