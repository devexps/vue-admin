...
import { useAppConfig, useGo, useSiteGeneral } from '@devexps/hooks'
import { useThrottleFn } from '@devexps/utils'
import { MixSidebarTriggerEnum } from '@devexps/constants'
import {
  getChildrenMenus,
...
<template>
  ...
  >
    ...
    <DevexpsScrollbar :style="{ height: `calc(100% - ${lagoHeight}px)` }">
      <DevexpsMenu
