...
import { useAppConfig, useAppInject } from '@devexps/hooks'
import { computed, unref, ref } from 'vue'
import { TriggerEnum } from '@devexps/constants'
import { useElementSize, MaybeComputedElementRef } from '@devexps/utils'
...
<template>
  ...
  >
    <DevexpsConfig :theme-mode="sidebar.theme" :inherit="false" abstract>
