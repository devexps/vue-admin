...
import { DevexpsFormProps, DevexpsFormSchema } from '#/form'
import { error } from '#/index'

export interface formMethod {
  // reload: () => void
  setProps: (props: DevexpsFormProps) => void
  validate: (
  ...
  updateSchemas: (schemas: DevexpsFormSchema) => void
}

export function useForm(props: DevexpsFormProps) {
