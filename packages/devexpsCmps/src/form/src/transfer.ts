import { ComponentType, DevexpsFormSchema } from '#/form'
...
export function transferFormilySchemas(props?: any): DevexpsFormSchema[] {
  const schemas: DevexpsFormSchema[] = []
...
const propsToSchema = (field: string, props: any): DevexpsFormSchema => {
  return {
    field,
    label: props['title'],
