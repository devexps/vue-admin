...
import { defineStore } from '@devexps/stores'
import { BASIC_HOME_PATH, BASIC_LOGIN_PATH, PageEnum } from '@devexps/constants'
import { router } from '@/router'
import { doLogoutApi, getUserInfoApi, doLoginApi } from '@/apis/auth'
import { PAGE_NOT_FOUND_ROUTE } from '@devexps/router'
import { useAuthStoreWithout } from './auth'
import { GetUserInfoModel } from '@/apis/sys/user'
import { UserInfo, RoleInfo } from '@devexps/types'
import { ErrorMessageMode } from '@devexps/types'
import { isArray } from '@devexps/utils'
